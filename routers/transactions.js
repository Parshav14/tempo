...
const c_name = await mySqlQury(`SELECT * FROM tbl_customers WHERE id = '${req.params.id}'`)
        res.render("add_payment_list", {
            role_data, lang_data, language_name, accessdata, notification_data, 
            register_packages_notification, shipment_notification, pickup_notification, 
            consolidated_notification, payment_data, customer_data, data_type : '2',c_name
        })
    } catch (error) {
        console.log(error);
    }
...
const c_name = await mySqlQury(`SELECT * FROM tbl_customers WHERE id = '${req.params.id}'`)
        res.render("add_payment_list", {
            role_data, lang_data, language_name, accessdata, notification_data, 
            register_packages_notification, shipment_notification, pickup_notification, 
            consolidated_notification, payment_data, customer_data, data_type : '3',c_name
        })
    } catch (error) {
        console.log(error);
    }
...
const c_name = await mySqlQury(`SELECT * FROM tbl_customers WHERE id = '${req.params.id}'`)
        res.render("add_payment_list", {
            role_data, lang_data, language_name, accessdata, notification_data, 
            register_packages_notification, shipment_notification, pickup_notification, 
            consolidated_notification, payment_data, customer_data, data_type : '4',c_name
        })
    } catch (error) {
        console.log(error);
    }
