...
router.get("/create_pickup", auth, async(req, res) => {
    try {
        ...
        const pickup_data = await mySqlQury(`SELECT * FROM tbl_pickup ORDER BY ID DESC LIMIT 1`)
        ...
        if (pickup_data == "") {
            ...
            if (pickup_data[0].id < 100) {
                let invoice = '0000' + (pickup_data[0].id + 1)
            ...
            }else if (pickup_data[0].id > 100) {
                let invoice = '000' + (pickup_data[0].id + 1)
            ...
            }else if (pickup_data[0].id > 1000) {
                let invoice = '00' + (pickup_data[0].id + 1)
            ...
            }else if (pickup_data[0].id > 10000) {
                let invoice = '0' + (pickup_data[0].id + 1)
                ...
                let invoice = (pickup_data[0].id + 1)
